...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "LewisUMarketplaceApp.Android.dll" comes first in this list. */
		"LewisUMarketplaceApp.Android.dll",
		"FormsViewGroup.dll",
		"LewisUMarketplaceApp.Core.dll",
		"LewisUMarketplaceApp.UI.dll",
